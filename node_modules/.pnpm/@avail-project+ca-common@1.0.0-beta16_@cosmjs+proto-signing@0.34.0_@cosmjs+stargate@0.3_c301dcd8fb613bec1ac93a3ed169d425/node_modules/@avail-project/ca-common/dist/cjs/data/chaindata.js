...
exports.RPCURLMap = exports.ChaindataMap = exports.Chaindata = void 0;
const viem_1 = require("viem");
const definition_1 = require("../proto/definition");
const chainid_1 = require("./chainid");
const currency_1 = require("./currency");
const permitutils_1 = require("../permitutils");
...
const RawData = [
    ...
    },
    {
        ...
        Currencies: [
            ...
            {
                CurrencyID: 2,
                PermitVariant: permitutils_1.PermitVariant.PolygonEMT,
                PermitContractVersion: 1,
...
class CurrencyMap {
    ...
    constructor(currencies) {
        for (const cur of currencies) {
            this.map.set((0, viem_1.toHex)(cur.tokenAddress), cur);
        }
    }
    get(input) {
        return this.map.get((0, utils_1.ezPadTo32Hex)(input));
    }
}
// Certain data fields are auto-generated while others are not.
exports.Chaindata = RawData.map((ch) => {
    const ch32 = Buffer.from((0, viem_1.hexToBytes)(ch.ChainID32));
    const currencies = ch.Currencies.map((cur) => {
        return new currency_1.Currency(cur.CurrencyID, (0, viem_1.hexToBytes)(cur.TokenContractAddress), cur.TokenDecimals, cur.PermitVariant, cur.PermitContractVersion, cur.IsGasToken);
    });
    return {
        Universe: ch.Universe,
        ChainID: new chainid_1.OmniversalChainID(ch.Universe, ch32),
        ChainID32: ch32,
        Currencies: currencies,
        CurrencyMap: new CurrencyMap(currencies),
    };
});
exports.ChaindataMap = new chainid_1.ChainIDKeyedMap(exports.Chaindata.map((ch) => [ch.ChainID, ch]));
